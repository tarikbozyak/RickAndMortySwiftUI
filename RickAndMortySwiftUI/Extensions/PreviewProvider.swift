...
class DeveloperPreview{
    ...
    let result = Character(id: 1, name: "Rick Sanchez", status: .Alive, species: .Human, type: nil, gender: .Male, origin: nil, location: nil, image: "https://rickandmortyapi.com/api/character/avatar/1.jpeg", episode: nil, url: "https://rickandmortyapi.com/api/character/1", created: "2017-11-04T18:48:46.250Z")
